...
<body class="min-h-screen bg-bg text-charcoal font-sans leading-relaxed flex flex-col">
    <header class="sticky top-0 z-30 bg-white/80 backdrop-blur">
        ...
        <div id="mobile-menu" class="md:hidden border-t border-gray-200 bg-white/95 px-4 pb-4 max-h-0 overflow-hidden opacity-0 pointer-events-none transition-[max-height,opacity] duration-300 ease-out">
